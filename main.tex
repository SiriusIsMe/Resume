...
\begin{document}
    ...
    \info{\faMap}{Moscow, Russia - ulitsa Pushkina Dom Kolotushkina}
    ...
    \doubleSkill{\faDatabase}{Programming Languages}{Python \textbullet{} C++ \textbullet{} Koomir \textbullet{}}
